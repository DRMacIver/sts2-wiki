...
version := env("STS2_VERSION", "v0.105.1")
...
build-all-versions:
    ...
    VERSIONS="v0.98.2 v0.99.1 v0.100.0 v0.101.0 v0.103.2 v0.105.1"
    LATEST="v0.105.1"
    ALL_VERSIONS="v0.105.1,v0.103.2,v0.101.0,v0.100.0,v0.99.1,v0.98.2"
